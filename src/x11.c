...
static ERL_NIF_TERM x11_window_create_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
...
static ERL_NIF_TERM x11_window_destroy_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
...
static ERL_NIF_TERM x11_window_put_pixel_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    int x, y;
    uint32_t rgb;
...
static ERL_NIF_TERM x11_window_put_image_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
	...
	XPutImage(display, window, context, image, 0, 0, 0, 0, window_attrs.width, window_attrs.height);
...
static ErlNifFunc nif_funcs[] = {
    {"create",       2,  x11_window_create_nif},
